 ...
 *
 * <p>
 * This class encapsulates details about employee events. It includes information such as
 * the type of event, employee's ID, email address, name, birthday, department name, and
 * the timestamp when the event was created.
 * </p>
 *
 * <p>
 * The birthday field is handled with custom JSON serialization and deserialization to
 * manage the {@link ZonedDateTime} format.
 * </p>
 *
