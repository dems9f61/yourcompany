 ...
 *
 * <p>
 * This serializer is responsible for converting {@link ZonedDateTime} objects into a JSON
 * string format. It specifically formats the datetime as a local date string, omitting
 * time and timezone information.
 * </p>
 *
 * <p>
 * The serializer extracts the local date part of the {@link ZonedDateTime} and converts
 * it to a string representation, which is then written as JSON output.
 * </p>
 *
