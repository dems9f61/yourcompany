 ...
 *
 * <p>This class provides a centralized exception handling mechanism across the entire application.
 * It intercepts exceptions thrown by any controller and processes them accordingly.</p>
 *
...
public class GlobalExceptionMapper {
     ...
     *
     * <p>This method is invoked when an unhandled exception occurs in the application.
     * It logs the exception and returns a standardized error response.</p>
     *
     ...
     *
     * <p>This method constructs an error response based on the provided exception and HTTP status.
     * It includes details such as the error message, the request URI, and the time of occurrence.</p>
     *
