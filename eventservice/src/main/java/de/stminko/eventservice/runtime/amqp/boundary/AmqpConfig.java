 ...
 *
 * <p>This class configures various AMQP resources such as queues, exchanges, bindings, and listeners
 * for RabbitMQ message handling. It defines necessary beans and settings for efficient message processing
 * in the application.</p>
 *
 * <p>Marked with {@code @Configuration} to indicate that it is a source of bean definitions.
 * The {@code @ConfigurationProperties(prefix = "amqp")} annotation indicates that its fields are
 * bound to properties prefixed with "amqp".</p>
 *
...
public class AmqpConfig {
    ...
    /**
     * Creates a {@link MappingJackson2HttpMessageConverter} bean with custom {@link ObjectMapper}.
     * This converter is used for serializing and deserializing message payloads.
     *
    ...
    /**
     * Creates a {@link Jackson2JsonMessageConverter} bean for message conversion.
     * This converter is used to serialize and deserialize messages to and from JSON.
     *
    ...
    /**
     * Configures a {@link SimpleRabbitListenerContainerFactory} to create listener containers.
     * This factory sets up message listener containers with specified configurations.
     *
    ...
    /**
     * Creates a primary {@link MethodInterceptor} bean for retry operations with RabbitMQ.
     * This interceptor implements retry logic with an exponential back-off policy.
     *
