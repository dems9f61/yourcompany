...
class EmployeeEventPublisherTest {
    ...
    void givenEmployee_whenEmployeeCreated_thenSendCreatedEmployeeMessage() {
        ...
        givenEmployee_whenEmployeeProcessed_thenSendEmployeeMessage((Employee value) -> publisher.employeeCreated(value),
                EmployeeMessage.EventType.EMPLOYEE_CREATED);
    }
    ...
    void givenEmployee_whenEmployeeCreated_thenSendDeletedEmployeeMessage() {
        givenEmployee_whenEmployeeProcessed_thenSendEmployeeMessage((Employee value) -> publisher.employeeDeleted(value),
                EmployeeMessage.EventType.EMPLOYEE_DELETED);
    }
    ...
    void givenEmployee_whenEmployeeCreated_thenSendUpdatedEmployeeMessage() {
        givenEmployee_whenEmployeeProcessed_thenSendEmployeeMessage((Employee value) -> publisher.employeeUpdated(value),
                EmployeeMessage.EventType.EMPLOYEE_UPDATED);
    }
    ...
    private void givenEmployee_whenEmployeeProcessed_thenSendEmployeeMessage(Consumer<Employee> block,
        ...
        Mockito.doNothing().when(template).convertAndSend(ArgumentMatchers.anyString(),
        ...
        // Assert
        verify(template).convertAndSend(ArgumentMatchers.eq(exchangeName),
