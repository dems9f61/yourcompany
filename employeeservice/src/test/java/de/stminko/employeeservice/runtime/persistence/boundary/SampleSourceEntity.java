...
class SampleSourceEntity {
	...
	static SampleSourceEntity sample() {
		SampleSourceEntity retVal = new SampleSourceEntity();
		...
		retVal.setZonedDateTimeProperty(ZonedDateTime.now());
