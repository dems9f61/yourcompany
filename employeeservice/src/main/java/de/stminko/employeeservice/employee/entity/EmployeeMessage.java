...
/**
 * Represents a message related to employee events in the system.
 * This class is used as a data carrier for employee event information.
 * It holds details about the type of event and the employee involved in that event.
 * <p>
 * The {@code EventType} enum inside this class categorizes the type of event,
 * such as creation, update, or deletion of an employee.
 * <p>
...
public class EmployeeMessage {
    ...
    /**
     * Enumerates the types of events that can occur to an employee.
     * This helps in categorizing and responding to different events differently.
     * The event types include:
     * - EMPLOYEE_CREATED: Indicates a new employee has been added to the system.
