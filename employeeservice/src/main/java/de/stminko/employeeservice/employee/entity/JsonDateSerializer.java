 ...
 * <p>
 * Method:
 * - serialize: Converts a {@link ZonedDateTime} object into a string representation.
 * The output format is the local date in ISO-8601 format (yyyy-MM-dd).
 * <p>
 * Usage:
 * This serializer can be applied to ZonedDateTime fields in data transfer objects using Jackson's
 * {@code @JsonSerialize} annotation to specify custom serialization behavior.
 *
