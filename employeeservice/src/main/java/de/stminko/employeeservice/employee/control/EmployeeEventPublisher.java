 ...
 * such as creation, deletion, and updates. It uses Spring AMQP's {@link RabbitTemplate} for message
 * sending and relies on {@link AmqpConfig} for configuration details like exchange name and routing key.
 * </p>
 *
