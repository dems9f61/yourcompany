 ...
 * <p>
 * This record is used to encapsulate the data received in requests for creating or
...
public record DepartmentRequest(@JsonView( {
		DataView.POST.class, DataView.PUT.class, DataView.PATCH.class }) @NullOrNotBlank(
				groups = { DataView.PATCH.class }) @NotBlank(message = "{errors.department.name.not-blank}",
						groups = { DataView.POST.class, DataView.PUT.class }) @Schema(
								description = "Name of the department", example = "Human Resources",
